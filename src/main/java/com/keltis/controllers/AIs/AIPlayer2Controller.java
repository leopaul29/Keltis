 ...
 *
 */
public class AIPlayer2Controller extends PlayerController {
	...
	private void basicAction() {
		...
		boolean action = this.playCardOnPathColor(c, playerPaths.get(Color.RED));
		KeltisLogger.infoAI("playCardOnPathColor " + c.toString() + " action on RED path is " + action);
